...
using Jgp.Issues.Sessions;
using Jgp.Issues.Web.Controllers.Results;
using Jgp.Issues.Web.Models;
using Jgp.Issues.Web.Models.Account;
...
{
    public class AccountController : IssuesControllerBase
    {
